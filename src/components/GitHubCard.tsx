    ...
    <div className="bg-[#141414] p-8 rounded-lg shadow-xl flex flex-col items-center max-w-full mx-auto border border-gray-800 hover:border-red-600 transition-all duration-300 md:p-12 lg:p-16">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start w-full mb-8">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-full mb-6 md:mb-0 md:mr-10 border-4 border-red-600 shadow-lg transform transition-transform duration-300 hover:scale-105"
        />

        <div className="text-center md:text-left flex-grow">
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-2 text-red-500 leading-tight break-words">
          ...
          <p className="text-base md:text-lg leading-relaxed text-gray-200 mb-4">
            {data.bio ||
              "Passionate about building scalable backend systems, real-time applications, and cloud-native solutions. Actively working on production-level projects and improving problem-solving skills."}
          </p>

          {data.location && (
            <p className="text-md text-gray-400 mb-2">📍 {data.location}</p>
          )}
      ...
      <div className="w-full text-center mt-4">
        <p className="text-gray-400">
          Building scalable systems • Open Source • Problem Solving
        </p>
      </div>
      ...
      <div className="w-full mt-8">
        <h3 className="text-xl lg:text-2xl font-bold mb-4 text-white text-left">
          Commit Activity
        </h3>
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="mt-10 px-12 py-4 bg-red-600 text-white text-xl font-bold rounded-full hover:bg-red-700 transition-all duration-300 flex items-center justify-center shadow-lg transform hover:scale-105"
      >
        <svg
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12 2C6.477 2 2 6.477 2 12c0 4.419 2.865 8.167 6.839 9.489.5.09.682-.217.682-.483 0-.237-.008-.867-.013-1.701-2.782.604-3.37-1.341-3.37-1.341-.454-1.154-1.11-1.462-1.11-1.462-.907-.618.069-.607.069-.607 1.002.07 1.531 1.029 1.531 1.029.892 1.528 2.341 1.087 2.906.832.091-.645.35-1.087.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.682-.104-.253-.447-1.27.098-2.651 0 0 .84-.27 2.75 1.025.799-.221 1.65-.331 2.5-.335.85.004 1.7.114 2.5.335 1.909-1.295 2.748-1.025 2.748-1.025.546 1.381.202 2.398.098 2.651.64.698 1.028 1.591 1.028 2.682 0 3.84-2.339 4.686-4.566 4.935.359.309.678.918.678 1.854 0 1.34-.012 2.424-.012 2.75 0 .269.18.577.688.481C21.139 20.165 24 16.417 24 12c0-5.523-4.477-10-10-10z"
          />
        </svg>
        Explore My GitHub
      </Link>
