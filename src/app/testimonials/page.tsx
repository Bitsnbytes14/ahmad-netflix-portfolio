...
export default function Testimonials() {
  const testimonials = [
    {
      quote:
        "Ahmad is an exceptional developer who consistently delivers high-quality work. His problem-solving skills and dedication are truly inspiring.",
      name: "Jane Doe",
    ...
    {
      quote:
        "Working with Ahmad was a pleasure. He's a great communicator and a brilliant mind, always finding innovative solutions.",
      name: "John Smith",
    ...
    {
      quote:
        "Ahmad's contributions to our open-source project were invaluable. His code is clean, well-documented, and highly efficient.",
      name: "Emily White",
